...
public class NonexistentMirror extends CustomRelic {
    public static final String ID = "sakura:NonexistentMirror";
    private static final Texture IMG = TextureLoader.getTexture("SakuraImages/relics/NonexistentMirror.png");
