...
public class IncompleteEncyclopedia extends CustomRelic implements SuperRareRelic {
    public static final String ID = "halation:IncompleteEncyclopedia";
    private static final Texture IMG = TextureLoader.getTexture("HalationImages/relics/IncompleteEncyclopedia.png");
